...
```{r wisc_age_hist, eval = FALSE}
#no-frills histogram
teachers_wisc[ , hist(birth_year)]
```
```{r wisc_age_hist_inv, echo = FALSE}
#Adding this to hide the output mess
invisible(
  teachers_wisc[ , hist(birth_year)]
)
```
...
```{r wisc_age_hist_title, eval = FALSE}
...
teachers_wisc[ , hist(birth_year, 
                      main = paste0("Distribution of Year of Birth\n",
                                    "Among Wisconsin Teachers"))]
```
```{r wisc_age_hist_title_inv, echo = FALSE}
invisible({
  teachers_wisc[ , hist(birth_year, 
                        main = "Distribution of Year of Birth among Wisconsin Teachers")]
  teachers_wisc[ , hist(birth_year, 
...
```{r wisc_age_hist_axes, eval = FALSE}
...
teachers_wisc[ , hist(birth_year, xlab = "Year of Birth",
                      main = paste0("Distribution of Year of Birth\n",
                                    "Among Wisconsin Teachers"))]
```
```{r wisc_age_hist_axes_inv, echo = FALSE}
invisible(
  teachers_wisc[ , hist(birth_year, xlab = "Year of Birth",
                        main = paste0("Distribution of Year of Birth\n",
                                      "Among Wisconsin Teachers"))]
...
```{r wisc_age_hist_col, eval = FALSE}
#something plain
...
teachers_wisc[ , hist(birth_year, xlab = "Year of Birth",
                      ...
                      main = paste0("Distribution of Year of Birth\n",
                                    "Among Wisconsin Teachers"))]
```
```{r wisc_age_hist_col_inv, echo = FALSE}
invisible({
teachers_wisc[ , hist(birth_year, xlab = "Year of Birth", col = "red",
                      main = paste0("Distribution of Year of Birth\n",
                                    "Among Wisconsin Teachers"))]
...
```{r wisc_age_hist_freq, eval = FALSE}
...
teachers_wisc[ , hist(birth_year, xlab = "Year of Birth",
                      ...
                      main = paste0("Distribution of Year of Birth\n",
                                    "Among Wisconsin Teachers"))]
```
```{r wisc_age_hist_freq_inv, echo = FALSE}
invisible(
teachers_wisc[ , hist(birth_year, xlab = "Year of Birth",
                      col = "darkslateblue", freq = FALSE,
                      main = paste0("Distribution of Year of Birth\n",
...
```{r wisc_hist_age_breaks, eval = FALSE}
...
teachers_wisc[ , hist(birth_year, xlab = "Year of Birth", breaks = 20,
                      ...
                      main = paste0("Distribution of Year of Birth\n",
                                    "Among Wisconsin Teachers"))]
```
```{r wisc_hist_age_breaks_inv, echo = FALSE, fig.keep = "all"}
invisible({
  cat("Default (Sturges)\n")
teachers_wisc[ , hist(birth_year, xlab = "Year of Birth",
                      col = "darkslateblue", freq = FALSE,
...
```{r wisc_dens_age_lwd, eval = FALSE}
teachers_wisc[ , plot(density(salary), main = "Density of Salaries",
                      xlab = "$", col = "darkgreen", lwd = 3)]
```
```{r wisc_dens_age_lwd_inv, echo = FALSE}
invisible(
teachers_wisc[ , plot(density(salary), main = "Density of Salaries",
                      xlab = "$", col = "darkgreen", lwd = 3)]
)
...
```{r wisc_dens_age_no_x, eval = FALSE}
teachers_wisc[ , plot(density(salary), main = "Density of Salaries",
                      xlab = "$", col = "darkgreen", lwd = 3,
                      xaxt = "n")]
```
```{r wisc_dens_age_no_x_inv, echo = FALSE}
invisible(
teachers_wisc[ , plot(density(salary), main = "Density of Salaries",
                      xlab = "$", col = "darkgreen", lwd = 3,
                      xaxt = "n")]
...
axis(side = 1, at = seq(0, 90000, by = 10000),
     labels = paste0("$", seq(0, 90, by = 10), "k"))
```
```{r wisc_dens_no_y_inv, echo = FALSE}
invisible({
  teachers_wisc[ , plot(density(salary), main = "Density of Salaries",
                        xlab = "$", col = "darkgreen", lwd = 3,
                        xaxt = "n", yaxt = "n")]
...
```{r scatter_out, eval = FALSE}
english[fringe<3e4, plot(salary, fringe, xlab = "Salary ($)",
                         ylab = "Fringe Benefits ($)",
                         main = "Fringe Benefits vs. Salary",
                         col = "darkblue")]
```
```{r scatter_out_inv, echo = FALSE}
invisible(
english[fringe<3e4, plot(salary, fringe, xlab = "Salary ($)",
                         ylab = "Fringe Benefits ($)",
                         main = "Fringe Benefits vs. Salary",
...
axis(side = 2, at = 5000*(0:5), las = 1,
     labels = paste0("$", 5*(0:5), "k"))
```
```{r scatter_color_inv, echo = FALSE}
invisible({
english[fringe<3e4, plot(salary, fringe, xlab = "Salary ($)",
                         ylab = "Fringe Benefits ($)",
                         main = "Fringe Benefits vs. Salary", yaxt = "n"
