...
Now we can examine the distribution on a more select/interesting sample of employees. Drawing histograms is managed through the `hist` function. It only needs one argument -- a vector which will be converted into a distribution.
